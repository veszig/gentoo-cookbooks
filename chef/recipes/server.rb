...
gentoo_package_keywords "=app-admin/chef-server-0.9.6"
gentoo_package_keywords "=app-admin/chef-server-api-0.9.6"
gentoo_package_keywords "=app-admin/chef-server-webui-0.9.6"
gentoo_package_keywords "=app-admin/chef-solr-0.9.6"
